...
\begin{figure}[htbp]
  \begin{center}
%    \mbox{
%    FIXME take pictures with height-ruler aside
      \subfigure[Carpet 1]{\includegraphics[width=0.3\textwidth]{figures/Krikkit3G.jpg}}\hfill
      \subfigure[Carpet 2]{\includegraphics[width=0.3\textwidth]{figures/Krikkit3G.jpg}}\hfill
      \subfigure[Carpet 3]{\includegraphics[width=0.3\textwidth]{figures/Krikkit3G.jpg}}
%      }
%    \mbox{
...
Schemata of the evaluation sensor to be developed.
From left to right:
...
It must be bright enough on every test surface (see \autoref{requirements}) %FIXXME chapter requirements
...
The .csv-files for all experiments are available FIXME.
...
Speed deviation for non-telecentric system for varying clearance heights. The non-telecentric system induces a linear error dependant on the surface distance. 
...
For every carpet, a number of tests with varying distance were done.
...
Carpet~1 has a very even surface, with allowed for the greatest height variations. 
...
Shown are the calibration factors of every single experiment compared to the mean value of 1\,m/s.
The results are well within 2\,\%, and are considered satisfactory.
}
\end{center}
\end{figure}
...
The game field lines of a RoboCup game field consist normally of white gaffer tape on top of the carpet.
It has the downside of being highly reflective and featuring very little contrast.
With the illumination of white or IR LEDs, this leads to a surface feature count not high enough for tracking.
But with the different surface feature count, we are able to distinguish white lines from the green carpet.
