...
A typical experiment plot for one measure is shown in~\autoref{example-plot}. 
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \mbox{
      \subfigure[Carpet 2]{\includegraphics[width=0.48\textwidth]{figures/beleuchtung-teppich2-scheinwerfer-blende10.PNG}}
      }
    \caption{
      The three different carpet types, on which the sensor must work.
      The light-green carpet~1~(a) is nearly felt-like with a very smooth surface.
...
10-13mm  13-16mm  16-19mm  3-5mm  5-8mm
...
Using a target distance of $5\,$mm we obtain a sensor bias as shown inFigure~\ref{fig:bias}a. 
