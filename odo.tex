...
It must be bright enough on every test surface to allow the automatic shutter control of the sensor minimize the shutter for the maximum frame-rate of 7080\,Hz. 
