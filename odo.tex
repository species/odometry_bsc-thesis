...
Image distance~$i_2$ to virtual image and object distance~$o_2$. % FIXME cite? from WP... but need better ref.
}
\end{center}
\end{figure}
...
At $\lambda = \unit[842]{nm}$, with a focal length of \unit[10]{mm} and an estimated aperture of \unit[0.8]{mm}, the Airy disks are~$\unit[12]{\muup m}$ apart.
