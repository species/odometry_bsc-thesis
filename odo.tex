...
It must be bright enough on every test surface (see \autoref{}FIXXME chapter requirements} to allow the automatic shutter control of the sensor minimize the shutter for the maximum frame-rate of 7080\,Hz. 
Other requirements are the available space on the robot for a sensor, and the power consumption. 
The illumination must fit besides the optical ray path inside the space constraints of $60\times60$\,mm$^2$.
...
Different types of illumination are evaluated.
