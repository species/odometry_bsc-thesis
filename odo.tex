...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\columnwidth]{figures/wiretapping.png}
\caption{\label{fig:wiretapping}
Implementation of the wire-tapping to catch the firmware (stage~1).
On top is the mouse on its original PCB.
...
To alter the properties of an optical system by expansion with more optical elements, the base system must be known exactly.
...
aperture 1.4\,mm
sensor plane - lens plane - image plane = 5.88m
lens material n=1.5713 at lambda=842\,nm
lens thickness 2.43\,mm


brennweite der linse geschaetzt aus den skizzen des datasheets und beobachtungen 
