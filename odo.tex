...
Any single LED of these provides still not enough luminous density, so an array of these LEDs are used.
...
Therefore, a small PCB is designed with nine LEDs in a circular array, and an opening in the centre for the optical beam (\autoref{fig:illupcb}).
