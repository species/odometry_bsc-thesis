...
The maximum speed is linear dependent of the field of view of the sensor.
...
The needed focal length $f_2$ of lens~2 is calculated from the LaPlace projection equation~\cite{jaeger} (\autoref{eq:1}). %FIXME auf deutsch heissts so, wie in EN-GB? (nur thin lens eq. gefunden, das is net das was wir wollen
...
second lens~L$_2$ with new aperture~A,
new object plane~O.
}
\end{center}
\end{figure}
...
\end{equation}
This inserted into the formula for the near limit $d_n = o_2 - 5$\,mm leads to the aperture diameter
\begin{equation}
o_2 - 5 = \frac{o_2 \cdot \frac{o_2}{6} \cdot \left( { \frac{D}{Z} + 1} \right) }{ \frac{o_2}{6} \cdot \left( { \frac{D}{Z} + 1} \right) + o_2  - \frac{o_2}{6} } \Rightarrow
\end{equation}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=1\columnwidth]{figures/lens_system_mouse.png}
...
veraendert magnification (und schaerfe?) nicht
