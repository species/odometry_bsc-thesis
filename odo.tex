...
But faulty mechanics are not always responsible for this type of error, it is sufficient if a wheel looses contact with the ground for a moment.
...
The main criterion against radar sensors are the very different reflection rates on different undergrounds (carpet, wood, concrete, steel, \dots).
...
And last, but not least we had a sample sensor sponsored from a German RoboCup team, where an exhaustive data sheet was available~\cite{adns}.
