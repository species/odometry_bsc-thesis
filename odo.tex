...
In an omnidirectional robot, the odometry system is more complex as three degrees of freedom~(DoF) have to be taken into account.
...
\subsection{Requirements for a New Type of Sensor}
