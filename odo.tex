...
Its mount allows for position calibration of the sensor in x~and~y - position as well as the angle of the sensor to the optical axis of the Micro-Bench.
...
Calibration set-up for the sensor on the Micro-Bench.
}
\end{center}
\end{figure}
